...
\draw[->] (0,-2.5,0) -- (0,3,0) node[anchor=north west]{$y$};
...
\fill ({2*cos(45)},{2*sin(45)},0) circle (0pt) node[anchor=south west]{$S'$};

\fill[fill=black] (0,0,0) circle (1pt);
\fill[fill=red] (1,0,0) circle (1pt) node[anchor=south west, red]{$x_{max}$};
\fill[fill=red] (2,0,0) circle (1pt) node[anchor=south west, red]{$x'_{max}$};
